  ...
  <section>
    ...
    >
      ...
      <template v-slot:item.logo="{ item }">
        <v-avatar @click="showLogoOverlay(item)">
          <img
            :src="item.logo.thumb"
            :alt="item.employer"
          >
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: 'Date From', align: 'start', value: 'from'},
        {text: 'Date To', align: 'start', value: 'to'},
  ...
  methods: {
    ...
    async save() {
      if (this.editedIndex > -1) {
        ...
        await this.$store.dispatch('experience/createExperience', this.editedItem).then((response) => {

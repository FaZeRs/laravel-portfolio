...
export default {
  ...
  data: () => ({
    ...
    workProcess1: require('../../img/Work-Process_1.png'),
    workProcess2: require('../../img/Work-Process_2.png'),
    workProcess3: require('../../img/Work-Process_3.png'),
    workProcess4: require('../../img/Work-Process_4.png'),
